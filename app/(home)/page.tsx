...
export default async function Home() {
  ...
  return (
    <div>
      ...
      <div className="mt-6">
        <h2 className="px-5 text-xl mb-3  text-gray-400 font-bold">Recomendados</h2>

        <div className="flex px-5 gap-4 overflow-x-auto [&::-webkit-scrollbar]:hidden">
          {barbershops.map((barbershop) => (
            <div key={barbershop.id} className="min-w-[167px] max-w-[167px] min-h-[200px]">
      ...
      <div className="mt-6 mb-[4.5rem]">
        <h2 className="px-5 text-xl mb-3  text-gray-400 font-bold">Populares</h2>
